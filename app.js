...
function aguardarFirebaseApp() {
  return new Promise((resolve) => {
    if (typeof window.db !== 'undefined') {
      console.log('✅ Firestore já disponível');
      resolve();
    } else {
...
aguardarFirebaseApp().then(() => {
  ...
  window.inicializarDatas = function() {
    ...
    if (document.getElementById('receitaData')) {
      document.getElementById('receitaData').value = hoje;
    }
    if (document.getElementById('despesaData')) {
  ...
  console.log('✅ app.js inicialização completa!');
});

console.log('⏳ app.js carregou, aguardando Firebase...');
console.log('📱 app.js carregando...');
